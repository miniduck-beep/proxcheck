...
func main() {
	log.Println("=== Реальное параллельное тестирование прокси ===")
	...
	// Берем первые 10 конфигураций для реального теста (меньше для скорости)
	...
	// Параллельное тестирование с реальными запросами
	log.Println("Starting real parallel proxy testing...")
	...
	log.Println("Real parallel testing completed.")
	...
	log.Println("\n=== Результаты реального параллельного тестирования ===")
	...
	log.Println("\n=== Статистика реального тестирования ===")
